...
function PageThree() {
  ...
  function setGenderChart() {
    const malePercentageDomestic = genderData[0].percentage[0] + "%";
    const femalePercentageDomestic = genderData[1].percentage[0] + "%";
    const malePercentageForeign = genderData[0].percentage[1] + "%";
        ...
        <div className="career-page-3__gender-chart">
          ...
          <div className="career-page-3__gender-chart__bar-container">
            <div className="career-page-3__gender-chart__bar-container__label">
              <span>{genderData[0].percentage[0]}%</span>
              <span>國內</span>
              <span>{genderData[1].percentage[0]}%</span>
            </div>
            <div className="career-page-3__gender-chart__bar">
              <div className="career-page-3__gender-chart__bar--male" id="male-bar-domestic" />
              <div className="career-page-3__gender-chart__bar--female" id="female-bar-domestic" />
            </div>
            <div className="career-page-3__gender-chart__bar-container__label">
              <span>{genderData[0].percentage[1]}%</span>
              <span>國外</span>
              <span>{genderData[1].percentage[1]}%</span>
            </div>
            <div className="career-page-3__gender-chart__bar">
              <div className="career-page-3__gender-chart__bar--male" id="male-bar-foreign" />
              <div className="career-page-3__gender-chart__bar--female" id="female-bar-foreign" />
            </div>
          </div>
          <div className="career-page-3__gender-chart__label">
            <img src={FemaleImg} />
